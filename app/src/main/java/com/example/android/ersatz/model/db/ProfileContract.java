...
public final class ProfileContract {
    ...
    public static final String CONTENT_AUTHORITY = "com.example.android.ersatz";
    ...
    public static final class ProfileEntry implements BaseColumns {
        ...
        public final static String COLUMN_PAGE_URL = "page_url";
        public final static String COLUMN_PAGE_ID = "page_id";
